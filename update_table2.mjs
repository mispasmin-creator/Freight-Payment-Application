...
let content = fs.readFileSync('src/components/FullKittingHistory.tsx', 'utf-8');
...
fs.writeFileSync('src/components/FullKittingHistory.tsx', content);
console.log('Done replacing styles in FullKittingHistory.');
